...
export default function LandingPage() {
  ...
  // Remove the fixed timeout - let the typing animation control the timing
  ...
  return (
    <>
      {/* Persistent glass morphic background to prevent black screen during transition */}
      <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-sm" />
      
      {/* Loading component with slide-up transition */}
      {isLoading && (
        <Loading 
      ...
      {/* Landing page content - only show after loading is complete */}
      {!isLoading && (
